...
The Research screen reads `/api/research/artifacts/latest`, which exposes the latest leaderboard, walk-forward summary, loop summary, raw plan, and consistency-selected plan generated by `stock-trade research-loop`.
